...
#include <glitch_frag.h>

namespace Pilot
{
    void PGlitchPass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PGlitchPass::setupDescriptorSetLayout()
    {
    ...
    void PGlitchPass::setupPipelines()
    {
        ...
        VkShaderModule frag_shader_module =
            PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, GLITCH_FRAG);
        ...
        pipelineInfo.subpass             = _main_camera_subpass_glitch;
    ...
    void PGlitchPass::setupDescriptorSet()
    {
    ...
    void PGlitchPass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
    ...
    void PGlitchPass::draw()
    {
        if (m_render_config._enable_debug_untils_label)
        {
            VkDebugUtilsLabelEXT label_info = {
                VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT, NULL, "Glitch", {1.0f, 1.0f, 1.0f, 1.0f}};
